...
"}")
        ...
        self.back_to_main_btn = QtWidgets.QPushButton(self.main_buttons_frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.back_to_main_btn.sizePolicy().hasHeightForWidth())
        self.back_to_main_btn.setSizePolicy(sizePolicy)
        self.back_to_main_btn.setMinimumSize(QtCore.QSize(90, 60))
        self.back_to_main_btn.setMaximumSize(QtCore.QSize(16777215, 60))
        self.back_to_main_btn.setLayoutDirection(QtCore.Qt.LeftToRight)
...
"")
        ...
        self.verticalLayout_2.addWidget(self.back_to_main_btn)
...
"    background-color: rgb(255, 255, 255);\n"
"\n"
"    image: url(:/icons/icons/open-order1.png);\n"
"    \n"
"}\n"
"\n"
"\n"
"QPushButton:hover{\n"
"    \n"
"    image:url(:/icons/icons/open-order2.png);\n"
"}\n"
"QPushButton:pressed{\n"
"    \n"
"\n"
...
"")
        ...
        self.about_us_btn = QtWidgets.QPushButton(self.frame)
        self.about_us_btn.setMinimumSize(QtCore.QSize(140, 100))
        self.about_us_btn.setMaximumSize(QtCore.QSize(140, 16777215))
        self.about_us_btn.setStyleSheet("QPushButton{\n"
"    border-style: solid;\n"
...
"}")
        ...
        self.daily_customers_name_filter_txt = QtWidgets.QLineEdit(self.frame_26)
        self.daily_customers_name_filter_txt.setMinimumSize(QtCore.QSize(300, 40))
        self.daily_customers_name_filter_txt.setMaximumSize(QtCore.QSize(300, 16777215))
        self.daily_customers_name_filter_txt.setClearButtonEnabled(True)
        self.daily_customers_name_filter_txt.setObjectName("daily_customers_name_filter_txt")
        self.horizontalLayout.addWidget(self.daily_customers_name_filter_txt)
...
"}")
        ...
        self.daily_customers_subsType_filter_comboBox = QtWidgets.QComboBox(self.frame_26)
        self.daily_customers_subsType_filter_comboBox.setMinimumSize(QtCore.QSize(300, 40))
        self.daily_customers_subsType_filter_comboBox.setMaximumSize(QtCore.QSize(400, 16777215))
        self.daily_customers_subsType_filter_comboBox.setObjectName("daily_customers_subsType_filter_comboBox")
        self.daily_customers_subsType_filter_comboBox.addItem("")
        self.daily_customers_subsType_filter_comboBox.setItemText(0, "")
        self.daily_customers_subsType_filter_comboBox.addItem("")
        self.daily_customers_subsType_filter_comboBox.addItem("")
        self.daily_customers_subsType_filter_comboBox.addItem("")
        self.daily_customers_subsType_filter_comboBox.addItem("")
        self.horizontalLayout_17.addWidget(self.daily_customers_subsType_filter_comboBox)
        ...
        self.verticalLayout_79.setSpacing(7)
...
"}")
        ...
        self.verticalLayout_79.addWidget(self.label_74)
        self.horizontalLayout_54 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_54.setSpacing(4)
        self.horizontalLayout_54.setObjectName("horizontalLayout_54")
        self.daily_customers_date_filter_dateEdit = QtWidgets.QDateEdit(self.frame_26)
        self.daily_customers_date_filter_dateEdit.setEnabled(True)
        self.daily_customers_date_filter_dateEdit.setMinimumSize(QtCore.QSize(240, 40))
        self.daily_customers_date_filter_dateEdit.setProperty("showGroupSeparator", False)
        self.daily_customers_date_filter_dateEdit.setCalendarPopup(True)
        self.daily_customers_date_filter_dateEdit.setObjectName("daily_customers_date_filter_dateEdit")
        self.horizontalLayout_54.addWidget(self.daily_customers_date_filter_dateEdit)
        self.verticalLayout_79.addLayout(self.horizontalLayout_54)
        self.horizontalLayout_18.addLayout(self.verticalLayout_79)
...
"}")
        ...
        self.label_73 = QtWidgets.QLabel(self.frame_36)
...
"}")
        ...
        self.orders_date_filter_dateEdit = QtWidgets.QDateEdit(self.frame_36)
        self.orders_date_filter_dateEdit.setEnabled(True)
        self.orders_date_filter_dateEdit.setMinimumSize(QtCore.QSize(240, 40))
        self.orders_date_filter_dateEdit.setProperty("showGroupSeparator", False)
        self.orders_date_filter_dateEdit.setCalendarPopup(True)
        self.orders_date_filter_dateEdit.setObjectName("orders_date_filter_dateEdit")
        self.horizontalLayout_53.addWidget(self.orders_date_filter_dateEdit)
        self.verticalLayout_78.addLayout(self.horizontalLayout_53)
        self.horizontalLayout_12.addLayout(self.verticalLayout_78)
...
"}")
        ...
        self.monthly_customers_name_filter_txt = QtWidgets.QLineEdit(self.frame_28)
        self.monthly_customers_name_filter_txt.setMinimumSize(QtCore.QSize(300, 40))
        self.monthly_customers_name_filter_txt.setMaximumSize(QtCore.QSize(300, 16777215))
        self.monthly_customers_name_filter_txt.setClearButtonEnabled(True)
        self.monthly_customers_name_filter_txt.setObjectName("monthly_customers_name_filter_txt")
        self.horizontalLayout_3.addWidget(self.monthly_customers_name_filter_txt)
...
"}")
        ...
        self.monthly_customers_subsState_filter_comboBox = QtWidgets.QComboBox(self.frame_28)
        self.monthly_customers_subsState_filter_comboBox.setMinimumSize(QtCore.QSize(300, 40))
        self.monthly_customers_subsState_filter_comboBox.setMaximumSize(QtCore.QSize(300, 16777215))
        self.monthly_customers_subsState_filter_comboBox.setObjectName("monthly_customers_subsState_filter_comboBox")
        self.horizontalLayout_28.addWidget(self.monthly_customers_subsState_filter_comboBox)
...
"}")
        ...
        self.monthly_customers_subsType_filter_comboBox = QtWidgets.QComboBox(self.frame_28)
        self.monthly_customers_subsType_filter_comboBox.setMinimumSize(QtCore.QSize(300, 40))
        self.monthly_customers_subsType_filter_comboBox.setMaximumSize(QtCore.QSize(300, 16777215))
        self.monthly_customers_subsType_filter_comboBox.setObjectName("monthly_customers_subsType_filter_comboBox")
        self.horizontalLayout_29.addWidget(self.monthly_customers_subsType_filter_comboBox)
...
"}")
        ...
        self.monthly_customers_date_filter_dateEdit = QtWidgets.QDateEdit(self.frame_28)
        self.monthly_customers_date_filter_dateEdit.setEnabled(True)
        self.monthly_customers_date_filter_dateEdit.setMinimumSize(QtCore.QSize(240, 40))
        self.monthly_customers_date_filter_dateEdit.setProperty("showGroupSeparator", False)
        self.monthly_customers_date_filter_dateEdit.setCalendarPopup(True)
        self.monthly_customers_date_filter_dateEdit.setObjectName("monthly_customers_date_filter_dateEdit")
        self.horizontalLayout_50.addWidget(self.monthly_customers_date_filter_dateEdit)
        self.verticalLayout_77.addLayout(self.horizontalLayout_50)
        self.horizontalLayout_26.addLayout(self.verticalLayout_77)
...
"}")
        ...
        self.reports_search_type_comboBox = QtWidgets.QComboBox(self.frame_37)
        self.reports_search_type_comboBox.setMinimumSize(QtCore.QSize(300, 40))
        self.reports_search_type_comboBox.setObjectName("reports_search_type_comboBox")
        self.reports_search_type_comboBox.addItem("")
        self.reports_search_type_comboBox.setItemText(0, "")
        self.reports_search_type_comboBox.addItem("")
        self.reports_search_type_comboBox.addItem("")
        self.reports_search_type_comboBox.addItem("")
        self.reports_search_type_comboBox.addItem("")
        self.horizontalLayout_32.addWidget(self.reports_search_type_comboBox)
        ...
        self.horizontalLayout_31.addWidget(self.report_clear_btn)
        ...
        self.reports_tableView.setMinimumSize(QtCore.QSize(0, 0))
...
"}")
        ...
        self.offers_date_filter_dateEdit = QtWidgets.QDateEdit(self.frame_48)
        self.offers_date_filter_dateEdit.setMinimumSize(QtCore.QSize(240, 40))
        self.offers_date_filter_dateEdit.setCalendarPopup(True)
        self.offers_date_filter_dateEdit.setObjectName("offers_date_filter_dateEdit")
        self.horizontalLayout_47.addWidget(self.offers_date_filter_dateEdit)
...
"}")
        ...
        self.shifts_date_filter_dateEdit = QtWidgets.QDateEdit(self.frame_53)
        self.shifts_date_filter_dateEdit.setMinimumSize(QtCore.QSize(240, 40))
        self.shifts_date_filter_dateEdit.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        self.shifts_date_filter_dateEdit.setButtonSymbols(QtWidgets.QAbstractSpinBox.UpDownArrows)
        self.shifts_date_filter_dateEdit.setCalendarPopup(True)
        self.shifts_date_filter_dateEdit.setObjectName("shifts_date_filter_dateEdit")
        self.horizontalLayout_51.addWidget(self.shifts_date_filter_dateEdit)
...
"}")
        ...
        self.verticalLayout_82 = QtWidgets.QVBoxLayout(self.about_us_tab)
        ...
        self.about_us_frame = QtWidgets.QFrame(self.about_us_tab)
        self.about_us_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.about_us_frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.about_us_frame.setObjectName("about_us_frame")
        self.verticalLayout_84 = QtWidgets.QVBoxLayout(self.about_us_frame)
...
"}")
        ...
        self.logo_frame_2 = QtWidgets.QFrame(self.about_us_frame)
        self.logo_frame_2.setMinimumSize(QtCore.QSize(200, 200))
        self.logo_frame_2.setMaximumSize(QtCore.QSize(200, 200))
        self.logo_frame_2.setStyleSheet("#logo_frame_2{\n"
"\n"
"    image: url(:/icons/icons/studyzone-logo.png);\n"
"\n"
"}")
        ...
        self.gridLayout_13 = QtWidgets.QGridLayout(self.logo_frame_2)
        self.gridLayout_13.setObjectName("gridLayout_13")
        self.verticalLayout_84.addWidget(self.logo_frame_2, 0, QtCore.Qt.AlignHCenter)
        self.frame_6 = QtWidgets.QFrame(self.about_us_frame)
...
"}")
        ...
        self.verticalLayout_84.addWidget(self.frame_6)
...
"}")
        ...
        self.label_76.setMaximumSize(QtCore.QSize(16777215, 50))
        self.label_76.setStyleSheet("QLabel{\n"
"    \n"
"    font: 100 italic 22pt \"Segoe UI\";\n"
"    padding:5px;\n"
"    background-color: transparent;\n"
"}")
        self.label_76.setAlignment(QtCore.Qt.AlignCenter)
        self.label_76.setObjectName("label_76")
        self.verticalLayout_83.addWidget(self.label_76)
        self.label_77 = QtWidgets.QLabel(self.frame_9)
        self.label_77.setMaximumSize(QtCore.QSize(16777215, 50))
        self.label_77.setStyleSheet("QLabel{\n"
"    color: rgb(255,255,255);\n"
"    \n"
"    font: 100 italic 15pt \"Segoe UI\";\n"
"    background:transparent;\n"
"}")
        self.label_77.setAlignment(QtCore.Qt.AlignCenter)
        self.label_77.setObjectName("label_77")
        self.verticalLayout_83.addWidget(self.label_77)
        self.verticalLayout_84.addWidget(self.frame_9, 0, QtCore.Qt.AlignHCenter)
        self.frame_25 = QtWidgets.QFrame(self.about_us_frame)
        self.frame_25.setMaximumSize(QtCore.QSize(16777215, 200))
...
"}")
        ...
        self.frame_39.setMaximumSize(QtCore.QSize(16777215, 120))
        ...
        self.label_81.setMinimumSize(QtCore.QSize(70, 70))
        self.label_81.setStyleSheet("QLabel{\n"
"    \n"
"    image: url(:/icons/icons/hc.png);\n"
"}")
        self.label_81.setText("")
        self.label_81.setObjectName("label_81")
        self.horizontalLayout_44.addWidget(self.label_81)
        self.label_82 = QtWidgets.QLabel(self.frame_39)
        self.label_82.setMinimumSize(QtCore.QSize(100, 100))
        self.label_82.setStyleSheet("QLabel{\n"
"    \n"
"    image: url(:/icons/icons/j_m.png);\n"
"}")
        self.label_82.setText("")
        self.label_82.setObjectName("label_82")
        self.horizontalLayout_44.addWidget(self.label_82)
        self.label_83 = QtWidgets.QLabel(self.frame_39)
        self.label_83.setMinimumSize(QtCore.QSize(100, 100))
        self.label_83.setStyleSheet("QLabel{\n"
"    \n"
"    image: url(:/icons/icons/latin.png);\n"
"}")
        self.label_83.setText("")
        self.label_83.setObjectName("label_83")
        self.horizontalLayout_44.addWidget(self.label_83)
        self.verticalLayout_81.addWidget(self.frame_39)
        self.verticalLayout_84.addWidget(self.frame_25)
        self.verticalLayout_82.addWidget(self.about_us_frame)
        self.tabWidget.addTab(self.about_us_tab, "")
        ...
        self.gridLayout_12.addItem(spacerItem46, 0, 1, 1, 1)
...
"")
        ...
        self.back_to_main_btn.clicked['bool'].connect(self.exit_btn.setDisabled)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Study Zone app"))
        ...
        self.about_us_btn.setText(_translate("MainWindow", "About Us"))
        ...
        self.label_24.setText(_translate("MainWindow", "Search and Filter by"))
        self.label_15.setText(_translate("MainWindow", "Customer Name"))
        self.label_32.setText(_translate("MainWindow", "Subscription Type"))
        self.daily_customers_subsType_filter_comboBox.setItemText(1, _translate("MainWindow", "Subscribed"))
        self.daily_customers_subsType_filter_comboBox.setItemText(2, _translate("MainWindow", "Not Subscribed"))
        self.daily_customers_subsType_filter_comboBox.setItemText(3, _translate("MainWindow", "Expired"))
        self.daily_customers_subsType_filter_comboBox.setItemText(4, _translate("MainWindow", "Subscribed to another center"))
        ...
        self.label_37.setText(_translate("MainWindow", "Search and Filter by"))
        self.label_41.setText(_translate("MainWindow", "Customer Name"))
        self.label_45.setText(_translate("MainWindow", "Order Type"))
        ...
        self.label_26.setText(_translate("MainWindow", "Search and Filter by"))
        self.label_27.setText(_translate("MainWindow", "Customer Name"))
        self.label_33.setText(_translate("MainWindow", "Subscription State"))
        self.label_34.setText(_translate("MainWindow", "Subscription Type"))
        self.label_72.setText(_translate("MainWindow", "Date"))
        ...
        self.label_35.setText(_translate("MainWindow", "Search and Filter by"))
        self.label_36.setText(_translate("MainWindow", "Item Name"))
        self.label_38.setText(_translate("MainWindow", "Item Type"))
        ...
        self.label_31.setText(_translate("MainWindow", "Search and Filter by"))
        self.label_40.setText(_translate("MainWindow", "Report type"))
        self.reports_search_type_comboBox.setItemText(1, _translate("MainWindow", "يومي"))
        self.reports_search_type_comboBox.setItemText(2, _translate("MainWindow", "شهري"))
        self.reports_search_type_comboBox.setItemText(3, _translate("MainWindow", "سنوي"))
        self.reports_search_type_comboBox.setItemText(4, _translate("MainWindow", "معدل الزبائن"))
        ...
        self.label_48.setText(_translate("MainWindow", "Search and Filter by"))
        self.label_49.setText(_translate("MainWindow", "Employee Name"))
        self.label_50.setText(_translate("MainWindow", "Job Type"))
        ...
        self.label_60.setText(_translate("MainWindow", "Search and Filter by"))
        self.label_62.setText(_translate("MainWindow", "Offer Name"))
        self.label_61.setText(_translate("MainWindow", "Date"))
        ...
        self.label_64.setText(_translate("MainWindow", "Search and Filter by"))
        self.label_66.setText(_translate("MainWindow", "Date"))
        self.shifts_date_filter_dateEdit.setDisplayFormat(_translate("MainWindow", "dd/MM/yyyy"))
